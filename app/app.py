...
# ── sidebar ───────────────────────────────────────────────────────────────────
st.sidebar.image(
    "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/NIFTY_50_Logo.svg/640px-NIFTY_50_Logo.svg.png",
    width=180,
)
...
best_return  = first_last["yearly_return"].max()
worst_return = first_last["yearly_return"].min()
...
heat_tickers = sel_tickers if len(sel_tickers) >= 2 else all_tickers[:15]
pivot = (
